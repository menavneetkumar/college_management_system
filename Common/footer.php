    ...
    <div class="container">
        <div class="row">
          <div class="col-md-3 col-sm-6 col-xs-12 segment-one md-mb-30 sm-mb-30">
            <h3>BVP College</h3>
            <p>This Project has been made by SANS  with the help of .
          ...
          <div class="col-md-3 col-sm-6 col-xs-12 segment-two md-mb-30 sm-mb-30">
            <h2>CONTACT DETAILS</h2>
              <p>Address: BHARATI VIDYAPEETH institute of Management and Entrepreneurship,
                  Rambung colony, Kothrud, 411038 PUNE – Maharashtra</p>
              <p>Telephones: (+92 42) 35978525-32</p>
              <p>E-mail: admissions@bvp.edu.pk</p>
        </div>
      </div>
    </div>
    </div>
  <p class="footer-bottom-text">CopyRights © reserved by SANS.2023</p>
</footer>