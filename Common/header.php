...
<html>
<head>
	<title>Home-College Of IMED</title>
...
<nav class="navbar navbar-expand-lg navbar-dark header-back sticky-top header-navbar-fonts">
	<a class="navbar-brand d-flex align-items-center" href="index.php">
		<img src="images/imed_logo.jpg" class="logo-image" width="50" height="50">
		<h3 class="text-light text-uppercase ml-2">IMED College</h3>
	</a>
